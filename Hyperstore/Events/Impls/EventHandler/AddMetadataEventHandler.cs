...
{
    internal class AddMetadataEventHandler : IEventHandler<AddSchemaEntityEvent>
    {
        ///-------------------------------------------------------------------------------------------------
        /// <summary>
        ...
        /// </returns>
        ///-------------------------------------------------------------------------------------------------
        public IEnumerable<IDomainCommand> Handle(IDomainModel domainModel, AddSchemaEntityEvent @event)
        {
            ...
            if (domainModel.GetElement(@event.Id, metadata) == null)
                yield return new AddSchemaEntityCommand(domainModel as ISchema, @event.Id, metadata);
        }
    }
}