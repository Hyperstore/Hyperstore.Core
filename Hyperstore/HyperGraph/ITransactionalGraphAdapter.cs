...
{
    //public interface ITransactionalGraphAdapter : IQueryGraphAdapter
    //{
    //    /// <summary>
    //    /// Creates the node.
    //    /// </summary>
    ...
    //    /// <param name="startSchema">The start schema.</param>
    ...
    //    /// <param name="ownerMetadata">The owner metadata.</param>
    //    /// <param name="property">The property.</param>
    //    /// <param name="value">The value.</param>
    //    /// <param name="version"></param>
    //    /// <returns></returns>
    //    PropertyInfo SetPropertyValue(Identity ownerId, ISchemaEntity ownerMetadata, ISchemaProperty property, object value, long? version);
    //}
}